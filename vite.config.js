...
export default defineConfig({
    ...
    plugins: [
        laravel({
            input: [
                ...
                'addons/seeding/resources/js/seeding-workspace.jsx',
                'addons/seeding/resources/css/seeding-workspace.css',
            ],
            refresh: true,
        }),
        react(),
    ...
    resolve: {
        ...
        alias: {
            ...
            '@seeding-addon': path.resolve(__dirname, 'addons/seeding/resources/js'),
